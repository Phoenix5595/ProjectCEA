// ESP32 TWAI Full V5 (MAX31865 x2 + BME280 + SCD30 + VL53) - Multi-Node Support
// - Same as Full V4 but without status frame for efficiency
...
void setup() {
  ...
  delay(1200);
  Serial.println("\n\n========================================");
  Serial.printf("=== ESP32 FullV5 Node %d + TWAI ===\n", NODE_ID);
  Serial.println("========================================\n");
