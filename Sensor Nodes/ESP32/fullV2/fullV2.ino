// ESP32 TWAI Full V2 (MAX31865 x2 + BME280 + SCD30 + VL53)
// - Same as Full V1 but transmits every 1 second
...
void setup() {
  Serial.begin(115200);
  delay(1200);
  Serial.println("=== ESP32 FullV2 + TWAI ===");
...
void loop() {
  ...
  if (millis() - last1 >= 1000) { // 1 second cadence
    ...
    Serial.print("[FullV2] T1="); Serial.print(last_temp1_c, 2);
