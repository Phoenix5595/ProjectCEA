...
class DeviceController:
    ...
    async def _apply_control_output(
        ...
        try:
            ...
            await self._log_control_action(location, cluster, device_name, device_type, control_output, current_time)
    ...
    async def _control_dimmable_light(
        ...
        try:
            ...
            await self.dfr0971_manager.set_intensity(board_id, channel, intensity_percent)
