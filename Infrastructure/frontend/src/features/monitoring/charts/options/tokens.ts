...
export const MONITORING_TOKEN_NAMES = {
  ...
  familyWaterContent: '--mon-family-water-content',
  familyConductivity: '--mon-family-conductivity',
  familyPh: '--mon-family-ph',
...
const FALLBACK: Record<MonitoringTokenName, string> = {
  ...
  familyDevice: '#c8d6c2',
  familyLight: '#c0dd55',
  familyWaterContent: '#00fff2',
  familyConductivity: '#c0dd55',
  familyPh: '#bd4253',
  nodeFront: '#00fff2',
  nodeBack: '#c0dd55',
