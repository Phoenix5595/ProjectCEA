        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="w-full lg:w-1/6 flex flex-col gap-4">
              <GrafanaPanel dashboardUid={DASHBOARD_UID} panelId={1} title="Sensor Values" height={972} />
            </div>
            ...
            <div className="w-full lg:w-5/6 flex flex-col gap-4">
              ...
              <GrafanaPanel dashboardUid={DASHBOARD_UID} panelId={5} title="Pressure and Devices" height={300} />
            </div>
