...
export default function DeviceManager() {
 ...
 <div className="p-6">
 <div className="mb-6">
 <h2 className="text-2xl font-bold text-text-input mb-2">Device Management</h2>
 <p className="text-text-muted">Manage MCP board pins (channels 0-15). Name devices and assign types.</p>
 </div>

 <div className="bg-surface-primary rounded-lg shadow-md border border-border-subtle overflow-hidden">
 ...
 return (
 <tr key={channel} className={isEmpty ? "bg-surface-secondary/50" : "hover:bg-surface-secondary"}>
 <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-text-input">
 {channel}
 </td>
 ...
 className="w-full px-2 py-1 border border-border-emphasis rounded-sm focus:outline-hidden focus:ring-2 focus:ring-btn-primary-light bg-surface-primary text-text-input"
 placeholder="Device name"
 />
 ) : (
 channelInfo?.device_name || <span className="text-text-subtle italic">Empty</span>
 )}
 </td>
 <td className="px-4 py-3 whitespace-nowrap text-sm text-text-secondary">
 {isEditing ? (
 ...
 <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-btn-primary-dim/30 text-btn-primary-text">
 {channelInfo.device_type}
 </span>
 ) : (
 ...
 channelInfo?.light_name || <span className="text-text-subtle">-</span>
 )}
 </td>
 <td className="px-4 py-3 whitespace-nowrap text-sm text-text-secondary">
 {isEditing ? (
 ...
 className="w-full px-2 py-1 border border-border-emphasis rounded-sm focus:outline-hidden focus:ring-2 focus:ring-btn-primary-light text-xs bg-surface-primary text-text-input"
 >
 ...
 onClick={saveEdit}
 disabled={saving}
 className="px-3 py-1 bg-btn-primary-light text-text-default rounded-sm hover:bg-btn-primary-hover disabled:opacity-50 disabled:cursor-not-allowed"
 >
 {saving ? 'Saving...' : 'Save'}
 </button>
 <button
 onClick={cancelEdit}
 disabled={saving}
 className="px-3 py-1 bg-surface-quaternary text-text-input rounded-sm hover:bg-surface-quinary disabled:opacity-50"
 >
 Cancel
 </button>
 </div>
 ...
 className="px-3 py-1 bg-btn-primary-light text-text-default rounded-sm hover:bg-btn-primary-hover"
 >
 {isEmpty ? 'Add' : 'Edit'}
 </button>
 )}
