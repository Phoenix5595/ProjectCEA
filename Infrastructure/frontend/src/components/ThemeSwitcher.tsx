  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col items-end gap-1 pointer-events-auto">
      ...
      <select
        ...
        className="bg-surface-secondary text-text-default border border-border-default rounded px-2 py-1 text-sm shadow-lg focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent-vivid appearance-none cursor-pointer"
